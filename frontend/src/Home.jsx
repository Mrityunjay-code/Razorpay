...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const options = {
            ...
            image: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.FtnqaDQ2FRF8ys8QRpFFrAHaHa%26pid%3DApi&f=1&ipt=5e0922a9f8d3659fc09983dda391d4a92f2dcc95a971ab2e3a229fa514fba94c&ipo=images",
            order_id: order.id,
            callback_url: "http://localhost:4000/api/paymentverification",
            prefill: {
                name: "Manish Kumar",
                email: "ms432@example.com",
                contact: "9999999999"
            },
            notes: {
